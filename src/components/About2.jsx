...
const Logo = styled.div`
  width: 90px;
  height: 90px;
  background-image: url("./jayoung/public/images/ProfileSmile.png");
  ...
  ${(props) =>
    props.heart &&
    css`
      background-image: url("./jayoung/public/images/smile.png");
      animation: none;
    `}
`;
...
const Envelope = styled.div`
  width: 45px;
  height: 40px;
  background-image: url("./jayoung/public/images/Envelope.png");
  background-repeat: no-repeat;
  background-size: contain;
  margin-top: 5px;
  margin-right: 20px;
...
const EmptyHeart = styled.div`
  width: 40px;
  height: 40px;
  background-image: url("./jayoung/public/images/EmptyHeart.png");
  background-repeat: no-repeat;
  background-size: contain;
  @media (max-width: 768px) {
    width: 25px;
  ...
  ${(props) =>
    props.heart &&
    css`
      background-image: url("./jayoung/public/images/Heart.png");
      animation: none;
    `}
`;
