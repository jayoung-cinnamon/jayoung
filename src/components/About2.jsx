...
const Logo = styled.div`
  width: 90px;
  height: 90px;
  background-image: url("https://jayoung-cinnamon.github.io/jayoung/ProfileSmile.png");
  ...
  ${(props) =>
    props.heart &&
    css`
      background-image: url("https://jayoung-cinnamon.github.io/jayoung/smile.png");
      animation: none;
    `}
`;
...
const Envelope = styled.div`
  width: 45px;
  height: 40px;
  background-image: url("https://jayoung-cinnamon.github.io/jayoung/Envelope.png");
  background-repeat: no-repeat;
  background-size: contain;
  margin-top: 5px;
  margin-right: 20px;
...
const EmptyHeart = styled.div`
  width: 40px;
  height: 40px;
  background-image: url("https://jayoung-cinnamon.github.io/jayoung/EmptyHeart.png");
  background-repeat: no-repeat;
  background-size: contain;
  @media (max-width: 768px) {
    width: 25px;
  ...
  ${(props) =>
    props.heart &&
    css`
      background-image: url("https://jayoung-cinnamon.github.io/jayoung/Heart.png");
      animation: none;
    `}
`;
